...
def get_nnet(name, **kwargs):
    if name == 'uvit':
        ...
        from libs.uvit_t2i_copy import UViT
        return UViT(**kwargs)
        return UViT(**kwargs)
    elif name == 'uvit_t2i_label':
        from libs.uvit_t2i_label import UViT
        return UViT(**kwargs)
    elif name == 'uvit_label':
        from libs.uvit_label import UViT
        return UViT(**kwargs)
        ...
        return DiT_XL_2(**kwargs)
    elif name == 'Unet':
        from libs.openaimodel import UNetModel
